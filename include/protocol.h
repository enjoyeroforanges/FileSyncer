...
inline bool isValidMessage(const Message& msg){
...
inline void writeBytes(std::vector<char>& buf, std::string_view val){
    buf.insert(buf.end(), val.begin(), val.end());
}


inline std::vector<char> serialize(const Message& msg){
...
inline std::vector<char> serialize(const Map &map, const std::string path){
    // for sending hashes
    std::vector<char> buffer;
    buffer.push_back('V');
    buffer.push_back('V');
...
inline void writeToFile(const std::vector<char>& buf, const std::string& path){
...
inline void appendToFile(const std::vector<char>& buf, const std::string& path){
...
inline int serializeFile(const std::filesystem::path path, Opcode op){
...
inline std::string opcode_to_string(const Opcode opcode){
    switch (opcode){
...
inline std::vector<ReadMessage> getRawBytes(const std::string& path){
